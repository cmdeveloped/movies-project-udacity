...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function () {
          $('.movie-tile').hide().first().fadeIn(700, function showNext() {
            $(this).next("li").fadeIn(700, showNext);
          });
          //Animation to reveal and hide storyline
          $(".movie-tile").mouseover(function(){
            $(this).children('p, h4').fadeIn();
          });
          $(".movie-tile").mouseleave(function(){
            $(this).children('p, h4').fadeOut();
          });
        });
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">cmdeveloped   movie trailers</a>
          </div>
        </div>
      </div>
    </div>
...
<li class="movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <h4 class='storyline'>Click for Trailer!</h4>
</li>
'''
